...
import { createCustomerWithDep } from 'src/features/customers/core/interactors';
...
export function CreateCustomerCard(): JSX.Element {
  ...
  const onSubmit = handleSubmit(async (customer) => {
    const response = await createCustomerWithDep(customer as Customer);
