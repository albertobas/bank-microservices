...
import { depositToAccountWithDep } from 'src/features/accounts/core/interactors';
...
export function DepositToAccountCard(): JSX.Element {
  ...
  const onSubmit = handleSubmit(async ({ number, amount }) => {
    const response = await depositToAccountWithDep(number, amount);
